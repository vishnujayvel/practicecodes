...
public class EString {
    ...
    public static int amatch(String str, String pat) {
       ...
       // System.out.println("Inside amatch: str="+str+"\t"+"pat="+pat+"\n");
        while (i < str.length() && j < pat.length()) {
            char p = pat.charAt(j);
         //   System.out.println("P="+p+"\n");
            // stop if pattern is * or #
            //  System.out.println("Inside amatch Inside while \n i="+i+"\t"+"j="+j+"\t"+"p="+p+"\t"+"count"+count+"\n");
            if (p == '*' || p == '#')
                return count;
            if (str.charAt(i) != p) 
            {
    ...
    public static int findPat(String str, String pat) {
        int count = 0;
   //     System.out.println("Inside FindPat: Str="+str+"Pat="+pat+"\n");
    ...
    static boolean matchA(String str, String pat, String matches[]) {
     ...
     // System.out.println("Inside matchA \n i="+i+"\t"+"j="+j+"\t"+"pos="+pos+"\n");
        while (pos < pat.length() && j < matches.length) {
           ...
           //    System.out.println("p==*");
             ...
             //       System.out.println("* is the last thing in pat");
                    n = str.length() - i;
         ...
         //       System.out.println("Temp="+temp);
            ...
            else if (p == '#') 
            {
               ...
               //   System.out.println("\n n="+n);
                if (n <= 0) return false;
                i += n; pos += n;
               //  System.out.println("Third Else After visiting amatch \n i="+i+"\t"+"j="+j+"\t"+"pos="+pos+"\n");
            }
        }
 ...
 //               pat = pat.substring(1);
    ...
    public static boolean match(String str, String pat, String matches[]) {
       // System.out.println("\n Inside match function:\n Str="+str+"pat="+pat);
        boolean stat=matchA(str, pat, matches);
